...
async function confirmarAperturaCaja() {
  const monto = Number(document.getElementById('input-monto-apertura').value);
...
function actualizarDiferenciaCierre() {
  const contado = Number(document.getElementById('input-monto-contado').value) || 0;
...
async function confirmarCierreCaja() {
  const contado = Number(document.getElementById('input-monto-contado').value);
...
function actualizarVueltoPOS() {
  ...
  const entregado = Number(document.getElementById('pos-monto-entregado').value) || 0;
